...
import (
	...
	"github.com/deadlockx42/voidgen/source"
)

func renderDoc(s schema.Schema, output, pkg string) error {
...
func renderNew(s schema.Schema, output, pkg string) error {
...
func renderObjects(s schema.Schema, output, pkg string) error {
...
func renderArrays(s schema.Schema, output, pkg string) error {
...
func render(s schema.Schema, output string) error {
